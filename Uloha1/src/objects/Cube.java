...
public class Cube extends Solid {
    public Cube(){
        ...
        vertexBuffer.add(new Vertex(0,-1,3,col1));
        vertexBuffer.add(new Vertex(2,-1,3,col2));
        vertexBuffer.add(new Vertex(2,1,3,col3));
        vertexBuffer.add(new Vertex(0,1,3,col4));
